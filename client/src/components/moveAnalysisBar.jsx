export default function MoveAnalysisBar({ moveIndex, moves }) {
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-[#1e1b18] rounded border border-[#3a342e]">
                  ...
                  <p className="text-sm">
                    Analysis for this position would appear here, including evaluation, 
                    best moves, blunders, mistakes, inaccuracies, and brilliant ideas.
                  </p>
                </div>
              </div>
            </>
